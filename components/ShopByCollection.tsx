...
const CHIP_BG = ["bg-neutral-bg", "bg-gold-bg", "bg-terracotta-light", "bg-warn-bg", "bg-sage-bg"];
...
export default function ShopByCollection({
  ...
  collections: { slug: string; name: string; products: Product[] }[];
}) {
  ...
  return (
    <Reveal as="section" className="container-x section-tight">
      <div className="mb-8">
        ...
        <h2 className="display-2 mt-2">Shop by collection</h2>
      </div>
