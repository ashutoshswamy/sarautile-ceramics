...
-- and will error on any that already exist. After it, run every file in
-- migrations/ in order - this file holds none of their changes.
...
-- every row; migrations/005 lets signed-in users read their own) ----
